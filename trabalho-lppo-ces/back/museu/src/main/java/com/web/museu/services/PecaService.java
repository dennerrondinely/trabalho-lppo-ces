...
public Peca fromDTO(PecaDTO objDto) {
        return new Peca(objDto.getId(),objDto.getDataCadastro(),objDto.getData(),objDto.getObservacao(),objDto.getCodigoInterno(),objDto.getDescricao(),objDto.getIdCategoria());
    }
