...
class AgendamentosCreate extends React.Component {
    ...
    componentDidMount() {
      ...
      handleClick = () => {//T14:32:02-02:00 T14:32:02-02:00
        ...
        if(this.state.id){
          PUT(`eventos/${this.state.id}`,{id: this.state.id, descricao, inicioEvento: `2018-11-21T${inicioEvento}-02:00`, fimEvento: `2018-11-21T${fimEvento}-02:00`, data: `${data}T14:32:02-02:00`})
          .then(response => { 
